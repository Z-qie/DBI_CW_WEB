...
<?php
    ...
    $query = "SELECT * FROM Orders WHERE status = 'cancelled by user' OR status = 'cancelled by rep' ORDER BY order_ID DESC";
    ...
    echo
        "</div> <div class='title_fixed'>order cancelled (not sold): &nbsp; " . $count . " in total</div>";
    $conn = null;
?>
